...
# (project=scitex-introspect, owner=ywatanabe1989, repo=scitex-introspect,
...
TMPDIR="/tmp/publish-scitex_introspect-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-introspect dist/* uploaded to PyPI via manual OIDC trusted publishing"
