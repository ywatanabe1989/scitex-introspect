...
class TestGetCallGraph:
    ...
    def test_get_call_graph_function(self):
        ...
        from scitex_introspect import get_call_graph

        result = get_call_graph("scitex_introspect._resolve.resolve_object")
    ...
    def test_call_graph_module(self):
        ...
        result = get_call_graph("scitex_introspect._resolve")
        assert result["success"] is True
    ...
    def test_call_graph_with_timeout(self):
        ...
        result = get_call_graph("scitex_introspect._resolve", timeout_seconds=30)
    ...
    def test_call_graph_internal_only(self):
        ...
        result = get_call_graph(
            "scitex_introspect._resolve.resolve_object", internal_only=True
        )
        assert result["success"] is True
    ...
    def test_call_graph_includes_external(self):
        ...
        result = get_call_graph(
            "scitex_introspect._resolve.resolve_object", internal_only=False
        )
        assert result["success"] is True
...
class TestGetFunctionCalls:
    ...
    def test_get_function_calls_success(self):
        ...
        from scitex_introspect import get_function_calls

        result = get_function_calls("scitex_introspect._resolve.resolve_object")
        assert result["success"] is True
        assert "calls" in result
