...
class TestGetImports:
    ...
    def test_get_imports_success(self):
        ...
        from scitex_introspect import get_imports

        result = get_imports("scitex_introspect._resolve")
    ...
    def test_imports_categorized(self):
        ...
        result = get_imports("scitex_introspect._resolve", categorize=True)
        assert result["success"] is True
    ...
    def test_imports_not_categorized(self):
        ...
        result = get_imports("scitex_introspect._resolve", categorize=False)
        assert result["success"] is True
...
class TestGetDependencies:
    ...
    def test_get_dependencies_success(self):
        ...
        from scitex_introspect import get_dependencies

        result = get_dependencies("scitex_introspect._resolve")
        assert result["success"] is True
    ...
    def test_dependencies_non_recursive(self):
        ...
        result = get_dependencies("scitex_introspect._resolve", recursive=False)
        assert result["success"] is True
