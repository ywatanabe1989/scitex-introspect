...
class TestQQ:
    ...
    def test_qq_success(self):
        ...
        result = qq("scitex_introspect._resolve.resolve_object")
    ...
    def test_qq_max_lines(self):
        ...
        result = qq("scitex_introspect._resolve.resolve_object", max_lines=5)
        assert result["success"] is True
    ...
    def test_qq_without_decorators(self):
        ...
        result = qq(
            "scitex_introspect._resolve.resolve_object", include_decorators=False
        )
        assert result["success"] is True
